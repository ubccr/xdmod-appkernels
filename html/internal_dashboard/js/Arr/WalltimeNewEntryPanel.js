...
XDMoD.Arr.WalltimeNewEntryPanel = Ext.extend(Ext.FormPanel, {
    _DEFAULT_CONFIG: {
        layout: 'fit',
        width: 480,
        minWidth: 480,
    ...
    initComponent: function () {
        ...
        XDMoD.Arr.WalltimeNewEntryPanel.superclass.initComponent.apply(this, arguments);
    ...
    listeners: {
        ...
        ,
        hide: function () {
            /** NO-OP Fired when the containing window is hidden. **/
        }
        ,
        entry_creation_canceled: function () {
            this.ownerCt.close();
        }
        ,
    ...
    _createButtons: function (options) {
        ...
        this.buttons = [
            ...
            },
            {
                text: cancelText,
                handler: function () {
                    this.ownerCt.ownerCt.fireEvent('entry_creation_canceled');
                }
            }
        ];
    }
